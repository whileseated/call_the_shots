...
This script `01_create_entire-field.py` reveals player names and IDs from a specified URL and saves it to a CSV file. It uses Selenium with Chrome WebDriver to interact with a web page and extract information.
